...
<body>
    ...
    <div class="row">
        <div class="col-12">
            <div class="form-floating mb-3">
                <input type="number" class="form-control" id="qtd_alunos_curso" name="qtd_alunos_curso" placeholder="">
    ...
    <div class="col-12">
        <div class="form-floating mb-3">
            <input type="date" class="form-control" id="data_inicio_curso" name="data_inicio_curso" placeholder="">
            <label for="data_inicio_curso">Data de Início do Curso*</label>

        </div>
        <div class="col-12">
            <div class="form-floating mb-3">
                <input type="date" class="form-control" id="data_fim_curso" name="data_fim_curso" placeholder="">
